...
class ChatGPTTelegramBot:
    ...
    async def user_update(self, update:Update, context:ContextTypes.DEFAULT_TYPE):
        """
    ...
    async def prompt(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if update.message.from_user.id in self.awaiting_users or update.message.from_user.id not in self.usage:
            return
    ...
    async def admin_response_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if action == "admin_approve":
            ...
            response_text = f"User {user_id} has been denied."
        else:
